...
function App() {
  ...
  const [homeScore, homeSetScore] = useState(0); // Give these better names, and decide whether you want to pass an initial score into the state hook as the initialValue
